...
\bold{Lékařská a antidopingová komise}
...
\bold{Správce IAAF pro záležitosti dopingu}
...
\begitems \style N
\bold{Tíha důkazů a jejich měřítko}
...
\bold{Způsoby doložení skutečností a domněnek}
...
\bold{Zveřejnění a revize seznamu zakázaných prostředků}
...
\bold{Seznam zakázaných látek a zakázaných postupů}
...
\bold{Návrat k~soutěžím po zanechání činnosti nebo jiném období nečinnosti}
...
* Všechny vzorky odebrané podle těchto Antidopingových pravidel musí být analyzovány v~souladu s~těmito všeobecnými principy:
  \begitems \style a
  \bold{Využití akreditované laboratoře}
  ...
  * Bez písemného souhlasu atleta nesmí být žádný vzorek použit k~jinému účelu, než jak je popsáno v~P 36.1.b). Vzorky použité se souhlasem atleta k~jiným účelům, než uvedeným v~P 36.1.b), musí být zbaveny jakýchkoliv identifikačních prvků, aby nebylo později možné zpětně zjistit, komu byly odebrány.
  ...
  \bold{Standardy pro analýzu vzorků a zprávu}
...
\bold{Prozatímní zastavení činnosti}
...
\bold{Výjimečné/zvláštní okolnosti}
...
\begitems \style N
\bold{Zrušení výsledků v~soutěži, v~níž došlo k~porušení antidopingových pravidel}
...
\bold{Zákaz činnosti pro přítomnost, užití nebo pokus o~užití nebo vlastnictví zakázané látky nebo zakázaného způsobu}
...
\bold{Zákaz činnosti pro porušení jiných pravidel o~dopingu}
...
\bold{Zrušení nebo snížení doby zákazu činnosti pro zvláštní látky nebo s~ohledem na zvláštní okolnost}
...
\bold{Zrušení nebo snížení doby zákazu činnosti na základě výjimečných okolností}
...
\bold{Přitěžující okolnosti pro zvýšení doby zastavení činnosti}
...
\bold{Zrušení výsledků dosažených v~soutěži po následném odebrání vzorků nebo rozhodnutí o~porušení pravidel o~dopingu}
...
\bold{Počátek doby ztráty oprávnění k~účasti na soutěžích (zákazu soutěžní činnosti)}
...
\bold{Postavení atleta během doby ztráty způsobilosti k~účasti v~soutěžích}
* \begitems \style a
...
\bold{Návrat k~soutěžím po ztrátě způsobilosti k~účasti v~soutěžích}
...
\begitems \style N
\bold{Rozhodnutí, proti nimž lze podat odvolání}
...
\bold{Odvolání proti rozhodnutí týkající se porušení pravidel o~dopingu nebo následků}
...
\bold{Odvolání podaná WADA v~případě, kdy rozhodnutí není vydáno včas}
...
\bold{Odvolání proti rozhodnutí, které přiznává nebo odmítá výjimku pro terapeutické užití}
...
\bold{Odvolání proti sankci uvalené na člena za nedodržování závazků vyplývajících z~pravidel o~dopingu}
...
\bold{Lhůty pro podání odvolání k~CAS}
...
\bold{Protistrana při odvolání k~CAS}
