...
\noindent{\bf Dopingová revizní komise}
...
\noindent{\bf Správce IAAF pro záležitosti dopingu}
...
\begitems \style N
\noindent{\bf Tíha důkazů a jejich měřítko}
...
\noindent{\bf Způsoby doložení skutečností a domněnek}
...
\noindent{\bf Zveřejnění a revize seznamu zakázaných prostředků}
...
\noindent{\bf Seznam zakázaných látek a zakázaných postupů}
* Zakázané látky a zakázané postupy: Seznam zakázaných látek a~zakázaných postupů obsahuje ty látky a metody, které jsou zakázané vždy (jak v~soutěžním, tak v~mimosoutěžním období), neboť jsou schopné zvyšovat výkonnost v~budoucích soutěžích nebo zakrýt užití dopingu, a~dále ty látky a metody, které jsou zakázané pouze během soutěží. Zakázané látky a zakázané postupy mohou být na seznamu uvedené pouze jako obecná kategorie (např. anabolika) nebo s~odkazem na určitou látku nebo metodu.
...
\noindent{\bf Terapeutické užití}
* WADA přijala mezinárodní standard pro uplatňování výjimek pro terapeutické použití zakázané látky nebo postupu (\uv{TUE}).
...
\noindent{\bf Kontroly během soutěže}
...
\noindent{\bf Mimosoutěžní kontroly}
...
\noindent{\bf Návrat k~soutěžím po zanechání činnosti nebo jiném období nečinnosti}
...
* Všechny vzorky odebrané podle těchto Antidopingových pravidel musí být analyzovány v~souladu s~těmito všeobecnými principy:
  \begitems \style a
  \noindent{\bf Využití akreditované laboratoře}
  ...
  * Bez písemného souhlasu atleta nesmí být žádný vzorek použit k~jinému účelu, než jak je popsáno v~P 36.1.b). Vzorky použité se souhlasem atleta k~jiným účelům, než uvedeným v~P 36.1.b), musí být zbaveny jakýchkoliv identifikačních prvků, aby nebylo později možné zpětně zjistit, komu byly odebrány.
  ...
  \noindent{\bf Standardy pro analýzu vzorků a zprávu}
...
* Podle mezinárodních standardů, za určitých okolností, se požaduje, aby laboratoře oznámily přítomnost zakázaných látek, které mohou být produkovány endogenně, jako atypický nález k~dalšímu zkoumání. Na základě atypického nálezu zjištěného u~vzorku A, Správce IAAF pro záležitosti dopingu provede prvotní šetření zda
  \begitems \style a
...
* Správu výsledků v~rámci programu biologického pasu atletů má na starosti IAAF v~souladu s~postupy danými těmito Antidopingovými pravidly.
...
\noindent{\bf Prozatímní zastavení činnosti}
...
\noindent{\bf Výjimečné/zvláštní okolnosti}
...
* Pokud po prozkoumání předložených svědectví příslušný tribunál rozhodne, že žádné výjimečné či zvláštní okolnosti v~daném případě nejsou, musí na atleta uvalit sankce předepsané v~P 40. Členská federace musí do 5 pracovních dnů o~rozhodnutí tribunálu písemně uvědomit atleta a IAAF.
...
\begitems \style N
\noindent{\bf Zrušení výsledků v~soutěži, v~níž došlo k~porušení antidopingových pravidel}
...
\noindent{\bf Zákaz činnosti pro přítomnost, užití nebo pokus o~užití nebo vlastnictví zakázané látky nebo zakázaného způsobu}
...
\noindent{\bf Zákaz činnosti pro porušení jiných pravidel o~dopingu}
...
\noindent{\bf Zrušení nebo snížení doby zákazu činnosti pro zvláštní látky nebo s~ohledem na zvláštní okolnost}
...
\noindent{\bf Zrušení nebo snížení doby zákazu činnosti na základě výjimečných okolností}
...
\noindent{\bf Přitěžující okolnosti pro zvýšení doby zastavení činnosti}
...
\noindent{\bf Vícenásobná provinění}
* \begitems \style a
...
\noindent{\bf Zrušení výsledků dosažených v~soutěži po následném odebrání vzorků nebo rozhodnutí o~porušení pravidel o~dopingu}
...
\noindent{\bf Počátek doby ztráty oprávnění k~účasti na soutěžích (zákazu soutěžní činnosti)}
...
\noindent{\bf Návrat k~soutěžím po ztrátě způsobilosti k~účasti v~soutěžích}
* Pro opětovné získání způsobilosti k~činnosti po uplynutí doby zákazu, musí atlet nebo jiná osoba splnit následující podmínky:
  \begitems \style a
...
\begitems \style N
\noindent{\bf Rozhodnutí, proti nimž lze podat odvolání}
...
\noindent{\bf Odvolání proti rozhodnutí týkající se porušení pravidel o~dopingu nebo následků}
...
\noindent{\bf Odvolání podaná WADA v~případě, kdy rozhodnutí není vydáno včas}
* Pokud, v~určitém případě podle těchto pravidel o~dopingu, IAAF nebo člen nerozhodne o~tom, zda došlo k~porušení pravidel o~dopingu v~časové lhůtě stanovené WADA, může WADA podat odvolání přímo k~CAS, jako by IAAF nebo člen rozhodli, že k~porušení pravidel o~dopingu  nedošlo.  Pokud komise CAS rozhodne, že k~porušení pravidel o~dopingu došlo a WADA jednala správně, že se obrátila přímo na CAS, pak náklady WADA a právní poplatky za podání odvolání musí uhradit orgán (IAAF nebo člen), který své rozhodnutí neučinil.

\noindent{\bf Odvolání proti rozhodnutí, které přiznává nebo odmítá výjimku pro terapeutické užití}
...
\noindent{\bf Odvolání proti sankci uvalené na člena za nedodržování závazků vyplývajících z~pravidel o~dopingu}
...
\noindent{\bf Lhůty pro podání odvolání k~CAS}
...
\noindent{\bf Odvolání IAAF k~CAS}
...
\noindent{\bf Protistrana při odvolání k~CAS}
